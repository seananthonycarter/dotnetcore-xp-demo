...
try {
    ...
    & $mkcert -install
    & $mkcert "*.dotnetcore_xp_demo.localhost"
}
catch {
...
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.dotnetcore_xp_demo.localhost"
}
Add-HostsEntry "cm.dotnetcore_xp_demo.localhost"
Add-HostsEntry "id.dotnetcore_xp_demo.localhost"
Add-HostsEntry "www.dotnetcore_xp_demo.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.dotnetcore_xp_demo.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.dotnetcore_xp_demo.localhost"
    }


    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.dotnetcore_xp_demo.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.dotnetcore_xp_demo.localhost"
