...
if ($ByPass) {
  dotnet sitecore login --cm https://cm.dotnetcore_xp_demo.localhost/ --auth https://id.dotnetcore_xp_demo.localhost/ --allow-write true --client-id "SitecoreCLIServer" --client-secret "testsecret" --client-credentials true
}else {
  dotnet sitecore login --cm https://cm.dotnetcore_xp_demo.localhost/ --auth https://id.dotnetcore_xp_demo.localhost/ --allow-write true
}
...
Start-Process https://cm.dotnetcore_xp_demo.localhost/sitecore/
Start-Process https://www.dotnetcore_xp_demo.localhost/
